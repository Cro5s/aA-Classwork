...
// Write a function, minChange(coins, amount), that accepts an array of coin values and a target amount as arguments. The method should return the minimum number of coins needed to make the target amount. A coin value can be used multiple times.
