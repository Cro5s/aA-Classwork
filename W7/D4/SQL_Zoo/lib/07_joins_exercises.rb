...
def colleagues_of_garfunkel
  ...
  execute(<<-SQL)
    ...
    FROM actors AS art
    JOIN castings AS art_castings ON art_castings.actor_id = art.id
    JOIN movies ON movies.id = art_castings.movie_id
    JOIN castings AS co_castings ON co_castings.movie_id = movies.id
    JOIN actors AS co_actors ON co_actors.id = co_castings.actor_id
    WHERE art.name = 'Art Garfunkel' AND co_actors.name != 'Art Garfunkel';
  SQL
end
